                        ...
                        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                            <div class='max-w-md mx-auto space-y-6'>
                                ...
                                <form action="{{ route('answers.store', ['application' => $application->id]) }}" method="POST">
                                    ...
                                    <textarea required name="body" id="" cols="30" rows="6" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none"></textarea>
                                    ...
                                    <a href="{{route('dashboard')}}" type="submit" class="py-3 px-6 my-2 bg-red-500 text-white font-medium rounded hover:bg-red-700 cursor-pointer ease-in-out duration-300" value="Send">Cancel</a>
                                </form>
